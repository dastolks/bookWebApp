...
public class BookService {
    ...
    public Book findById(String id) {
     ...
     public void update(String idForAuthor, String nameChange, String isbnChange){
        Book placeHold = findById(idForAuthor);
        placeHold.setTitle(nameChange);
        placeHold.setIsbn(isbnChange);
        edit(placeHold);
    }
    
    public void addNew(String setName, String setIsbn, Author setAuthor){
        Book b = new Book(0);
        b.setTitle(setName);
        b.setIsbn(setIsbn);
        b.setAuthorID(setAuthor);
        edit(b);
    }
